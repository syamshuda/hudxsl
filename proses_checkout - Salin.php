<?php
// /proses_checkout.php (Versi Final dengan Perbaikan Error Trim)
...
try {
    // 1. Hitung subtotal, berat, dan jenis produk dari server (untuk validasi)
    ...
    // === PERBAIKAN DI SINI ===
    // Gunakan null coalescing operator (??) untuk memberikan nilai default string kosong jika tidak ada data
    ...
    if ($ada_produk_fisik_server) {
        ...
        if(empty($kurir) || empty($kecamatan_tujuan)) {
