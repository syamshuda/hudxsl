<?php
// /includes/header.php (Versi Final Diperbaiki)
...
if (isset($_SESSION['user_id'])) {
    ...
    $query_pesan = "SELECT COUNT(id) as total FROM pesan WHERE penerima_id = $user_id_header AND sudah_dibaca = 0";
